...
export default function legalinfo() {
  ...
  return (
    <section>
      <MetaTags page='legalinformation' />

      <Navbar />

      {/* Hero Section */}
      <section
        className='w-full relative min-h-screen py-10 flex flex-col justify-center items-center bg-no-repeat bg-center bg-cover'
      ...
      >
        <div className='text-center mt-30 px-4 sm:px-6 md:px-10 max-w-7xl w-full mb-8'>
          ...
          <p className='text-[#292F43] text-sm md:text-base  max-w-2xl mx-auto'>
            To ensure that we server you better, we created our legal
            information. Kindly read through and agree before sign up to our
            services
          </p>
        </div>
        <div className='absolute top-64 left-32 w-[312px] h-[312px] bg-[#B70AC1] opacity-50 blur-[150px] z-0'></div>
